...
typedef enum rtxmon_public_field {
    ...
    RTXMON_PUBLIC_FIELD_POWER_CONSUMPTION_DEFAULT_LIMIT_PERCENT = 32,
    RTXMON_PUBLIC_FIELD_POWER_CONSUMPTION_CURRENT_LIMIT_PERCENT = 33,
    RTXMON_PUBLIC_FIELD_TEMPERATURE_GPU_LIMIT_C = 34
...
typedef enum rtxmon_public_provider {
    ...
    RTXMON_PUBLIC_PROVIDER_COMPUTED_POWER_RATIO = 16,
    RTXMON_PUBLIC_PROVIDER_NVML_TEMPERATURE_THRESHOLD = 17
